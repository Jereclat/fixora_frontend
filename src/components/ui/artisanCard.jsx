      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {artisans.map((artisan) => (
            <div
              key={artisan.id}
              className="relative group bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-500 ease-out hover:shadow-xl hover:-translate-y-2 hover:scale-105 "
            >
              {/* Product Image */}
              ...
              <div className="p-6 pb-8">
                ...
                <div className="text-center mt-4">
                  <h3 className="text-lg font-semibold text-gray-900 group-hover:text-amber-800 transition-colors duration-300">
                    {artisan.name}
                  </h3>
