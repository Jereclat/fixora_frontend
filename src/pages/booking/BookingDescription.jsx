  ...
  return (
    <div className="min-h-screen w-full px-4">
      ...
      <div className="sm:px-8 md:px-16 lg:px-10 xl:px-10 pb-28 lg:pb-0">
        ...
        <div className="w-full ">
          <div className="flex flex-col gap-2 p-4">
            <div className="flex gap-6 justify-between">
              <p className="text-gray-500 text-sm font-medium leading-normal">Step 1 of 4</p>
            </div>
            <div className="rounded-full bg-[#e2e0df] h-2">
              <div className="h-2 rounded-full bg-brand" style={{ width: '25%' }}></div>
            </div>
            <p className="text-gray-500 text-sm font-normal leading-normal">Describe Issue</p>
          </div>
        </div>
        ...
        {/* Main Content Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 w-full  mx-auto">
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4 p-4">
              <label className="flex flex-col w-full">
                ...
                <textarea 
                  className="flex w-full min-w-0 flex-1 resize-y overflow-hidden rounded-xl text-gray-500 focus:outline-0 focus:ring-2 focus:ring-[#6d4c41]/50 border border-[#e2e0df] bg-white min-h-48 placeholder:text-gray-400 p-[15px] text-base font-normal leading-normal" 
            ...
            <div className="flex flex-col p-4">
              <div className="flex flex-col items-center gap-6 rounded-xl border-2 border-dashed border-gray-200 px-6 py-10">
                <div className="flex max-w-[480px] flex-col items-center gap-2">
                  ...
                  <p className="text-gray-500 text-sm font-normal leading-normal text-center">Drag and drop files here or click the button below. This helps artisans provide a more accurate quote.</p>
                </div>
                <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-blue-50 text-[#161413] text-sm font-bold leading-normal tracking-[0.015em] hover:bg-gray-200 transition-colors">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 rounded-xl bg-blue-100 p-6 lg:p-8">
              <div className="flex flex-col gap-5">
                <div className="flex items-center gap-3">
                 <Lightbulb size={40} className="text-blue-800"/>
                  <h3 className="text-xl font-bold text-blue-800">Helpful Tips</h3>
                </div>
        ...
        <div className="w-full mx-auto pt-8">
          <div className="flex justify-between gap-4 flex-wrap px-4 py-3 border-t border-[#e2e0df]">
            <button className="flex min-w-[84px] max-w-[480px] bg-blue-50 cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 px-5  text-[#161413] text-base font-bold leading-normal tracking-[0.015em] border-2 border-transparent hover:bg-gray-100 transition-colors">
              <span className="truncate">Back</span>
            </button>
            <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 px-5 bg-brand text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-blue-500 transition-colors">
